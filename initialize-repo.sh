...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-demo
echo     https://github.com/dkhopade/tap-gitops-demo
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-demo --public
git remote add origin https://github.com/dkhopade/tap-gitops-demo
git branch -M main
